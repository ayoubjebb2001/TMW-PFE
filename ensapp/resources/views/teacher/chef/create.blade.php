...
@section('title', 'New chef')
 
@section('content')
    
<div class="w-[70%] mx-auto bg-white p-6 rounded-md shadow-md">
    <h1 class="text-2xl font-semibold mb-4">Create a Chef Profile</h1>

    <form class="p-6" action="{{ route("chef.store") }}" method="POST">
        @csrf
        ...
        <div class="mb-4">
            ...
            <input type="text" name="lastname" id="lastname" class="mt-1 p-2 w-full border rounded-md focus:outline-none focus:ring focus:border-blue-300" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="cin" id="cin" class="mt-1 p-2 w-full border rounded-md focus:outline-none focus:ring focus:border-blue-300" required>
        </div>
