...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <h4 class="text-2xl my-4 mx-4">List de course de "{{ $module->module_name }}"</h4>
    ...
    <div class="flex justify-between items-center bg-white dark:bg-gray-900 p-4">
        ...
        <button class="bg-gray-50 dark:bg-gray-700 py-2 px-8 rounded-sm"><a class="dark:text-slate-300 text-gray-700" href="{{ route('course.create', ['id' => $module->id]) }}">Add new course</a></button>
